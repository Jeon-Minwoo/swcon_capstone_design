...
if __name__ == '__main__':
    ...
    img_name = './eval/%s-%03d-03.jpeg'%(sol_name, sol_idx)
 ...
 # round 2
    ...
    img_name = './eval/%s-%03d-02.jpeg' % (sol_name, sol_idx)
    ...
    # with open(f'./solution_info/{sol_name}-00{sol_idx}.yml', 'w') as outfile:
